...
class TestDataFrameProcessor(unittest.TestCase):
    ...
    def test_add_day_column(self):
        ...
        day_column_name = "Day"
        day_plus_time_name = "Date + Time"

        data = {date_column_name:
                    ["2023/04/17", "2023/04/19", "2023/04/24", "2023/04/24", "2023/04/26", "2023/04/26", "2023/04/28",
                     "2023/05/01", "2023/05/01", "2023/05/04", "2023/05/04", "2023/05/08", "2023/05/08", "2023/05/10",
                     "2023/05/10", "2023/05/12", "2023/05/12", "2023/05/15", "2023/05/15", "2023/05/17", "2023/05/17",
        ...
        DataFrameProcessor.add_day_column(
            ...
            day_plus_time_column_name=day_plus_time_name
        )
